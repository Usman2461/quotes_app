  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text(
          AppLocalizations.of(context)!.dailyQuotesPremium,
          style: TextStyle(color: Color(AdarkGrey)),
        ),
        leading: Icon(
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  FeatureTile(
                      text: "Currently free but with ads",
                      style: TextStyle(fontSize: 18.0)),
                  FeatureTile(
                      text: "Remove ads with premium version",
                      style: TextStyle(fontSize: 18.0)),
                  FeatureTile(
                      text: "Only \$0.99/month , billed annually",
                      style: TextStyle(fontSize: 18.0)),
                  SizedBox(
                    height: 10,
                  ),
                      ...
                      try {
                        showDialog(
                            ...
                            builder: (BuildContext context) {
                              return ProgressDialog(
                                message: "Just a moment. We are preparing...",
                              );
                            });
                        UserCredential user =
                        ...
                        if (user != null) {
                          Navigator.of(context).push(CustomPageRoute2(
                              child: MainScreen(), begin: Offset(1, 0)));
                        } else {
